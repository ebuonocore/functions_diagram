...
class Window_information:
    ...
    def show_informations(self):
        ...
        help_grid.append(("auto", "Place automaticly the objects on the screen"))
        ...
        for name, description in help_grid:
            ...
            lbl_txt = tki.Label(line, text=description, justify=tki.LEFT, anchor="w")
        ...
        label_image = tki.Label(frame.scrollable_frame, image=image_licence_tk)
