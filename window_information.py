...
class Window_information():
    ...
    def show_informations(self):
        ...
        help_grid.append(('export', "Export diagram to image \n(.SVG)"))
        ...
        help_grid.append(('edit', "Edit element\n(node or function)"))
        help_grid.append(
            ('erase', "Delete element\n(node, function or connexion)"))
        help_grid.append(('undo', "Undo"))
        help_grid.append(('redo', "Redo"))
        help_grid.append(
            ('auto', "Place automaticly the functions on the screen"))
